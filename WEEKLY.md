...
| **KV 等待占 TTFT 54.2/62.5/64.2%(request 级因果占比,闭环误差 ≤0.08%)** | S1 | **EXP-013(本周日解锁)** |
...
**缺口**:S3 的 D1 分解数字(进行中)与 D2 config 调优 A/B 数字;S4 等 D4。
**下周(8/24–8/30)目标**:D1 kernel 占比表 + 吞吐-batch 曲线figure;D2 调优 JSON
+ PR 六件套准备;可选 D3 目标锁定。
