...
AI assistance (Claude and Cursor) was used — Claude ran the tuning harness, prepared the benchmarks, and drafted the description; Cursor assisted with the rebase, dedup re-verification, and commit/DCO setup. I reviewed every changed line and ran the tests myself.
```
