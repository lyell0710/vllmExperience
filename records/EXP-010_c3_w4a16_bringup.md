...
- 与 A2.7B MoE（BF16, 4.62ms）与 dense 7B TP2（9.26ms）同框：30B 总参、~3B 激活 + W4A16 的 decode 速度与 2.7B 激活 BF16 相当——权重读取量近似（3B×0.5B/参 ≈ 2.7B×2B/参 的量级差被专家路由与 Marlin 反量化开销平衡，D1/D4 分解的对象）。
