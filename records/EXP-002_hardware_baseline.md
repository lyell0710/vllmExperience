...
- 〔勘注 2026-08-29〕**allreduce 带宽复测差异**：EXP-018《NCCL allreduce size 扫描》用同二进制（tool_sha 717b683182）、同 NCCL 2.28.9、同参数复测 1M–512M 区间，得 avg bus bw **6.20 GB/s**（平台 6.4–6.5），比本记录 1.78 GB/s 高 3.5 倍。本记录的 provenance 未记 PCIe 运行态与系统负载，无法回溯归因（候选：8/21 并发负载 / PCIe 未升 Gen4）。权威数字是否更新与下游 EXP-005/RESUME_EVIDENCE 措辞修订，待用户决策，见 EXP-018 §7。
