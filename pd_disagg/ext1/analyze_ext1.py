...
def main():
    ...
    with open(out, "w", newline="") as f:
        f.write("# source: pd_disagg/ext1/raw/EXP-013/ (client.jsonl + ext1_proxy_lines.txt"
                " + ext1_kv_lines.txt, same-host clocks)"
                " \u00b7 generated by pd_disagg/ext1/analyze_ext1.py \u00b7 "
