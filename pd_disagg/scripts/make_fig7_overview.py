#!/usr/bin/env python3
"""fig7 · 四臂饱和吞吐总览（README 门面图）。全部从 runs.jsonl 重算（README 约定 #3）。

用法: /root/venvs/kernel-opt/bin/python scripts/make_fig7_overview.py
输出: figures/fig7_saturation_overview.png
数字与 README 证据台账 B1 行逐位一致（completed / wall_time_s，饱和模式）。
"""
...
# 四臂固定配色（与 make_figures.py fig1-6 一色到底，README 硬约定 #6）
ARM_COLOR = {
    "colocate": "#2a78d6",
    "replica2": "#eb6834",
    "tp2": "#1baf7a",
...
PROV = ("source: results/b1_matrix/runs.jsonl (saturation, protocol v2, seed-per-point)"
        " · 2×RTX4090 · vLLM 0.25.1 · data 2026-08-21 · plotted 2026-08-25")
